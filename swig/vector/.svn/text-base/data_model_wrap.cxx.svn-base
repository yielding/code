...
_wrap_new_Ints__SWIG_3(int argc, VALUE *argv, VALUE self) {
  ...
  temp2 = static_cast< std::vector< int >::value_type >(val2);
  arg2 = &temp2;
  result = (std::vector< int > *)new std::vector< int >(arg1,(std::vector< int >::value_type const &)*arg2);DATA_PTR(self) = result;
...
SWIGEXPORT void Init_DataModel(void) {
  ...
  cInts.klass = rb_define_class_under(mDataModel, "Ints", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_std__vectorT_int_std__allocatorT_int_t_t, (void *) &cInts);
  ...
  rb_define_method(cInts.klass, "dup", VALUEFUNC(_wrap_Ints_dup), -1);
  rb_define_method(cInts.klass, "inspect", VALUEFUNC(_wrap_Ints_inspect), -1);
  rb_define_method(cInts.klass, "to_a", VALUEFUNC(_wrap_Ints_to_a), -1);
  rb_define_method(cInts.klass, "to_s", VALUEFUNC(_wrap_Ints_to_s), -1);
  rb_define_method(cInts.klass, "slice", VALUEFUNC(_wrap_Ints_slice), -1);
  rb_define_method(cInts.klass, "each", VALUEFUNC(_wrap_Ints_each), -1);
  rb_define_method(cInts.klass, "select", VALUEFUNC(_wrap_Ints_select), -1);
  rb_define_method(cInts.klass, "reject!", VALUEFUNC(_wrap_Ints_rejectN___), -1);
  rb_define_alias(cInts.klass, "delete_if", "reject!");
  rb_define_method(cInts.klass, "delete_at", VALUEFUNC(_wrap_Ints_delete_at), -1);
  rb_define_method(cInts.klass, "__delete2__", VALUEFUNC(_wrap_Ints___delete2__), -1);
  rb_define_method(cInts.klass, "pop", VALUEFUNC(_wrap_Ints_pop), -1);
  rb_define_method(cInts.klass, "push", VALUEFUNC(_wrap_Ints_push), -1);
  rb_define_alias(cInts.klass, "<<", "push");
  rb_define_method(cInts.klass, "reject", VALUEFUNC(_wrap_Ints_reject), -1);
  rb_define_method(cInts.klass, "at", VALUEFUNC(_wrap_Ints_at), -1);
  ...
  rb_define_method(cInts.klass, "shift", VALUEFUNC(_wrap_Ints_shift), -1);
  rb_define_method(cInts.klass, "unshift", VALUEFUNC(_wrap_Ints_unshift), -1);
  rb_define_method(cInts.klass, "empty?", VALUEFUNC(_wrap_Ints_emptyq___), -1);
  rb_define_method(cInts.klass, "size", VALUEFUNC(_wrap_Ints_size), -1);
  rb_define_method(cInts.klass, "clear", VALUEFUNC(_wrap_Ints_clear), -1);
  rb_define_method(cInts.klass, "swap", VALUEFUNC(_wrap_Ints_swap), -1);
  rb_define_method(cInts.klass, "get_allocator", VALUEFUNC(_wrap_Ints_get_allocator), -1);
  rb_define_method(cInts.klass, "begin", VALUEFUNC(_wrap_Ints_begin), -1);
  rb_define_method(cInts.klass, "end", VALUEFUNC(_wrap_Ints_end), -1);
  rb_define_method(cInts.klass, "rbegin", VALUEFUNC(_wrap_Ints_rbegin), -1);
  rb_define_method(cInts.klass, "rend", VALUEFUNC(_wrap_Ints_rend), -1);
  rb_define_method(cInts.klass, "erase", VALUEFUNC(_wrap_Ints_erase), -1);
  rb_define_method(cInts.klass, "front", VALUEFUNC(_wrap_Ints_front), -1);
  rb_define_method(cInts.klass, "back", VALUEFUNC(_wrap_Ints_back), -1);
  rb_define_method(cInts.klass, "assign", VALUEFUNC(_wrap_Ints_assign), -1);
  rb_define_method(cInts.klass, "resize", VALUEFUNC(_wrap_Ints_resize), -1);
  rb_define_method(cInts.klass, "insert", VALUEFUNC(_wrap_Ints_insert), -1);
  rb_define_method(cInts.klass, "reserve", VALUEFUNC(_wrap_Ints_reserve), -1);
  rb_define_method(cInts.klass, "capacity", VALUEFUNC(_wrap_Ints_capacity), -1);
  rb_define_method(cInts.klass, "map_bang", VALUEFUNC(_wrap_Ints_map_bang), -1);
  rb_define_method(cInts.klass, "__delete__", VALUEFUNC(_wrap_Ints___delete__), -1);
  cInts.mark = 0;
