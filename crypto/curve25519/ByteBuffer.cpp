...
{
    uint16_t res = *(uint16_t*)&m_buffer[size_t(m_offset)];
    m_offset += 2;
...
{
    int16_t res = *(int16_t*)&m_buffer[size_t(m_offset)];
    m_offset += 2;
...
{
    int32_t res = *(int32_t*)&m_buffer[size_t(m_offset)];
    m_offset += 4;
...
{
    uint32_t res = *(uint32_t*)&m_buffer[size_t(m_offset)];
    m_offset += 4;
