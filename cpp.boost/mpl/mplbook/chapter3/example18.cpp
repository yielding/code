/*
    ...
    using the following command: 
        ...
        cl /nologo /Zm800 /EHsc -I- -I..\..\boost_1_32_0  /Fe%TEMP%\metaprogram-chapter3-example18.exe example18.cpp
...
{
    // no forwarding for MSVC6; it chokes.
    typedef typename
...
using namespace std; // abs is not in std:: in MSVC6
float rounding_error = abs((m2 - m).value());

    assert(rounding_error < .001);
    return 0; // MSVC warning suppressor
}
