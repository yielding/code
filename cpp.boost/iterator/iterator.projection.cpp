...
int main(int, char*[])
{
    ...
    boost::transform_iterator<select_name , list<personnel_record>::iterator>
    ...
    boost::transform_iterator<select_ID, list<personnel_record>::iterator> 
    ...
    boost::transform_iterator<select_ID, list<personnel_record>::const_iterator, int const& >
    ...
    copy(boost::make_transform_iterator<select_name>(personnel_list.begin()) , 
