...
public:
  ...
  //
  // pair<(const_)iterator, (const_)iterator> 
  //    equal_range(const Key& key) (const);
  // Usage: pair<AVLTree<int, int>::iterator, AVLTree<int, int>::iterator>
...
template <typename Key, typename Value, typename Comparator>
auto AVLTree<Key, Value, Comparator>::insert(const Key &key, const Value &value) -> pair<iterator, bool>
{
...
auto AVLTree<Key, Value, Comparator>::rotate_up(Node *node) -> void
{
  ...
  auto child  = node->_children[otherSide];
