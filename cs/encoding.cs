...
namespace Encoding
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      var euckr = System.Text.Encoding.GetEncoding(euckrCodepage);

      // 위에서 만든 변수를 이용하여 Byte의 배열로 문자열을 인코딩하여 얻는 부분입니다.
      var utf8Bytes = utf8.GetBytes(s);
      Console.Write("UTF-8 : ");
      ...
      // 인코딩된것을 문자열로 변환하기
      var decodedStringByEUCKR = euckr.GetString(euckrBytes);
      var decodedStringByUTF8  = utf8.GetString(utf8Bytes);
